...
task lift {
    ...
    command <<<
        ...
        if ((`cat b38.txt` > `cat b37.txt`)); then
            ...
            time /sumstats_imputation/scripts/lift.py -chr "#CHR" -pos POS -ref Allele1 -alt Allele2 \
...
task harmonize {
    ...
    command <<<
        ...
        python3 /sumstats_imputation/scripts/harmonize.py ${base} ${gnomad_ref_base} ${n} ${options}\
